...
namespace RDST
{
   ...
   Sphere::intersect(const Ray& ray) const
   {
      ...
      return Intersection(true, t, ray.o + (ray.d*t), glm::normalize(n), Surface(getColor(), getFinish()));
   }
   ...
   Plane::intersect(const Ray& ray) const
   {
      ...
      return Intersection(true, t, ray.o + (ray.d*t), n, Surface(getColor(), getFinish()));
   }
   ...
   Triangle::intersect(const Ray& ray) const
   {
      ...
      return Intersection(true, t, ray.o+(ray.d*t), getNormal(), Surface(getColor(), getFinish()));
   }
}